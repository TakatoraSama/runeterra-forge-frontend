...
const CARDS = {
	...
	"Garen1": {
		...
		"LevelUpTo": "Garen2",
		"AbilityType": "",
		"BalanceValues": {"play_buff": 1, "levelup_threshold": 6},
	...
	"Garen2": {
		...
		"Power": 9,
		"Keyword": ["Regeneration"],
		"Skill": "{Play}: Grant allies +{play_buff} Power. [br] {Round End}: {Rally} ALL allies.",
		"LevelUp": "",
		"LevelUpTo": null,
		"AbilityType": "",
	...
	"Quinn1": {
		...
		"Power": 5,
		"Keyword": ["Scout"],
		"Skill": "{Play}: {Spawn} [Valor] 2 at another location and grant it :Challenger:{Challenger}.",
		"LevelUp": "I've seen [Valor] win the lane once.",
		"LevelUpTo": "Quinn2",
		"AbilityType": "",
		"BalanceValues": {},
	...
	"Quinn2": {
		...
		"Power": 6,
		"Keyword": ["Scout"],
		"Skill": "{Play}: {Spawn} [Valor] 3 at another location and grant it :Challenger:{Challenger}.",
		"LevelUp": "",
		"LevelUpTo": null,
		"AbilityType": "",
		"BalanceValues": {},
