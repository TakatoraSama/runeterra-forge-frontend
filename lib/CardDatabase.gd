...
const CARDS = {
	...
	"Hecarim1": {
		...
		"PreviewTooltip": ["Hecarim1", "Hecarim2", "SpectralRiders"]
	},
	"Hecarim2": {
		"Name": "Hecarim",
		"Region": ["Shadow Isles"],
	...
	"Zed1": {
		...
		"Power": 2,
		"Keyword": ["Elusive"],
		"Skill": "When I {swap} lane, summon a [Living Shadow] at the original lane and I {strike} an enemy here.",
	...
	"Zed2": {
		...
		"Power": 3,
		"Keyword": ["Elusive"],
		"Skill": "When I {swap} lane, summon a [Living Shadow] with my Power at the original lane and I {strike} an enemy here.",
		"LevelUp": "",
		"LevelUpTo": null,
		"AbilityType": "",
		"BalanceValues": {},
